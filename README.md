...
- A verificação de follow depende de uma requisição GET ao endpoint de follows do Roblox. O script não força o follow; ele apenas verifica o estado retornado pela API.
