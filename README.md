...
- O executor precisa suportar requisições HTTP GET e POST. A busca de amigos usa POST em `presence.roblox.com`; o filtro BR também depende do POST em `gamejoin.roblox.com`. Se alguma validação falhar, o script interrompe a busca em vez de escolher um servidor sem confirmação.
